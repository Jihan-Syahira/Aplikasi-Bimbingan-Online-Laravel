...
class MahasiswaKPController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect(route('mahasiswa.bimbingan.kp'))->with(array('message' => 'Simpan Berhasil!','info' => 'success'));
    }
    ...
    public function d_store(Request $request, $id)
    {
        ...
        return redirect(url('/mahasiswa/data/bimbingan/kerja_praktik/riwayat/'.$id))->with(array('message' => 'Simpan Berhasil!','info' => 'success'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect(route('mahasiswa.bimbingan.kp'))->with(array('message' => 'Ubah Berhasil!','info' => 'info'));
    }
    public function d_update(Request $request, $id, $od)
    {
        ...
        return redirect(url('/mahasiswa/data/bimbingan/kerja_praktik/riwayat/'.$id))->with(array('message' => 'Ubah Berhasil!','info' => 'info'));
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect(route('mahasiswa.bimbingan.kp'))->with(array('message' => 'Hapus Berhasil!','info' => 'error'));
    }
    public function d_destroy($id, $od)
    {
        ...
        return redirect(url('/mahasiswa/data/bimbingan/kerja_praktik/riwayat/'.$id))->with(array('message' => 'Hapus Berhasil!','info' => 'error'));
    }
