...
class DetailController extends Controller
{
     ...
     * @return void
     */
    private $kategori = ['KP' => 'kerja_praktik','TA' => 'tugas_akhir','Pengajuan' => 'pengajuan_judul'];
    ...
    public function store(Request $request, $id)
    {
        ...
        $kat = $kategori[$bimbingan->kategori];
        BimbinganDetail::create($data);

        return redirect(url('/admin/data/bimbingan/'.$kat.'/detail/'.$id))->with(array('message' => 'Simpan Berhasil!','info' => 'success'));
    }

    public function d_store(Request $request, $id, $od)
    {
        $data = [
            'id_bimbingan' => $id,
            'tanggal' => $request->tanggal,
