...
class DosenPengajuanController extends Controller
{
    ...
    public function json()
    {
        ...
        $bimbingan = Bimbingan::select('id')->where('kategori', 'Pengajuan')->where('id_dosen', $dosen->id)->get()->toArray();
    ...
    public function store_komentar(Request $request)
    {
        ...
        return redirect(url('/dosen/data/bimbingan/pengajuan_judul/riwayat/'.$request->id_detail))->with(array('message' => 'Ubah Berhasil!','info' => 'info'));
    }
    ...
    public function upload_file(Request $request)
    {
        ...
        if (isset($file)) {
            ...
            return redirect(url('/dosen/data/bimbingan/pengajuan_judul/riwayat/'.$request->id_detail))->with(array('message' => 'Upload Berhasil!','info' => 'info'));
