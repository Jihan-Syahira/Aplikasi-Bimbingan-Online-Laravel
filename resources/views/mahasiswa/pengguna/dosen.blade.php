          ...
          <form action="#" method="POST" id="compose-form" class="form-horizontal" enctype="multipart/form-data">
              ...
              <div class="modal-body"> 
                  <div class="form-group row">
                      <label class="col-sm-3">Nama Dosen</label>
                      <div class="col-sm-9">
                        <input type="text" name="nama" class="form-control" required placeholder="Nama Dosen..">
                      </div>
                  </div> 
                  <div class="form-group row">
                      <label class="col-sm-3">NIP/NIDN</label>
                      <div class="col-sm-9">
                        <input type="text" name="nip" class="form-control" required placeholder="NIP/NIDN Dosen">
                      </div>
                  </div>
                  <div class="form-group row">
                      <label class="col-sm-3">Telepon</label>
                      <div class="col-sm-9">
                        <input type="number" name="no_hp" class="form-control" required placeholder="Nomor Telepon Dosen">
                      </div>
                  </div>
              </div>
          ...
          <form action="#" method="POST" id="compose-form-akun" class="form-horizontal" enctype="multipart/form-data">
              ...
              <div class="modal-body"> 
                  ...
                  <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                        <input type="text" name="level" class="form-control" readonly value="Dosen">
                      </div>
                  </div>
              </div>
              <div class="modal-footer">
            ...
            columns: [{
                ...
                },
                {
                    ...
                    render: function(data, type, row) {
                        ...
                        <a class="btn btn-danger btn-hapus" data-id="' + data + '" data-handler="dosen" href="<?= url($page.'/delete') ?>/' + data + '">\
                        <i class="fa fa-trash"></i> </a> \
					              <form id="delete-form-' + data + '-dosen" action="<?= url($page.'/delete') ?>/' + data + '" \
