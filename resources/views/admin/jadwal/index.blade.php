          ...
          <form action="#" method="POST" id="compose-form" class="form-horizontal" enctype="multipart/form-data">
              ...
              <div class="modal-body"> 
                  <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                        <input type="date" name="tanggal" class="form-control" required placeholder="NIP/NIDN Dosen">
                      </div>
                  </div>
                  <div class="form-group row">
                      <label class="col-sm-3">Dosen</label>
                      <div class="col-sm-9">
                        <select name="id_dosen" id="id_dosen" class="form-control p-0 px-2">
...
<script>
    ...
    function kosongkan()
    {
        ...
        jQuery("#compose-form select[name=id_dosen]").val("");
    }
</script>
@endSection