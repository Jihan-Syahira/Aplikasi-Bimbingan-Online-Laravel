          ...
          <form action="#" method="POST" id="compose-form" class="form-horizontal" enctype="multipart/form-data">
              ...
              <div class="modal-body"> 
                  ...
                  <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                        <select name="id_mahasiswa" id="id_mahasiswa" class="form-control p-0">
...
<script>
    $(function() {
      $.ajax({
        ...
        $.ajax({
            url: "<?=url('admin/user/mahasiswa/json');?>",
            type: "GET",
            cache: false,
            dataType: 'json',
            success: function (dataResult) { 
                ...
                var resultData = dataResult.data;
                $.each(resultData,function(index,row){ 
                    $('#id_mahasiswa').append('<option value="' + row.id + '">'+ row.nim + ' - ' + row.nama +  '</option>');
                })
            }
        });
