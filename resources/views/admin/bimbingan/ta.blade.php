          ...
          <form action="#" method="POST" id="compose-form" class="form-horizontal" enctype="multipart/form-data">
              ...
              <div class="modal-body"> 
                  <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                        <input type="text" name="judul" class="form-control" required placeholder="Judul tugas akhir">
                      </div>
                  </div>
                  <div class="form-group row">
                      <label class="col-sm-3 pl-5">Mahasiswa</label>
                      <div class="col-sm-9">
...
<script>
            ...
            columns: [{
                ...
                },
                {
                    ...
                    render: function(data, type, row) {
                        ...
                        <a class="btn btn-danger btn-hapus" data-id="' + data + '" data-handler="ta" href="<?= url($page.'/delete') ?>/' + data + '">\
                        <i class="fa fa-trash"></i> </a> \
					              <form id="delete-form-' + data + '-ta" action="<?= url($page.'/delete') ?>/' + data + '" \
        ...
        $.ajax({
            ...
            success: function (dataResult) { 
                ...
                $.each(resultData,function(index,row){
                    ...
                    jQuery("#compose-form select[name=id_mahasiswa]").val(row.id_mahasiswa);
    ...
    function kosongkan()
    {
      ...
      jQuery("#compose-form select[name=id_mahasiswa]").val(0);
