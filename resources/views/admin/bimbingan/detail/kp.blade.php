  ...
  <div class="col-lg-12 grid-margin stretch-card">
    <div class="card">
      <div class="card-body">
        ...
        <h3 class="card-title">{{$title}}<br>{{$load->judul}}</h3>
          ...
          <form action="#" method="POST" id="compose-form" class="form-horizontal" enctype="multipart/form-data">
              ...
              <div class="modal-body"> 
                  ...
                  <div class="form-group row">
                      ...
                      <div class="col-sm-8">
                        <textarea name="keterangan" placeholder="contoh : Bimbingan Penulisan" class="form-control" required></textarea>
                      </div>
                  </div>
                  <div class="form-group row">
...
<script>
    ...
    function kosongkan()
    {
      ...
      jQuery("#compose-form select[name=paraf]").val('Menunggu');
    }
</script>
@endSection